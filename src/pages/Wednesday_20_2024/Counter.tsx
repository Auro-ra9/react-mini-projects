...
//5. Build a button that changes its text to "Clicked!" when clicked.
  ...
  return (
    <div className="h-screen bg-gray-100">
      <button
        ...
        } text-white px-4 py-2 my-2 mx-2 rounded transition `}
        onClick={() =>
      ...
      <button
        className={
          "bg-green-800 hover:bg-green-600 text-white px-4 py-2 my-2 mx-2 rounded transition "
        } onClick={()=>setText((prev)=>prev==='Clicked'?'Click me':'Clicked')} >
        {text}
      </button>
